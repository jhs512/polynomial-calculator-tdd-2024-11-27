...
import static org.example.postfix.Postfix.getInstance;

import org.example.postfix.Postfix;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;

public class PostfixRecursiveTest {

    Postfix postfix = getInstance();
    ...
    void t1() {
        ...
        //when
        int result = postfix.calculatePostfixRecursive(postfix.infixToPostfix(expression));
