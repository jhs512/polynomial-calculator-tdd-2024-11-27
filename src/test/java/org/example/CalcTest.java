...
class CalcTest {
    ...
    @DisplayName("10 * -4 = -40")
    void t29(){
        assertThat(Calc.run("10 * -4")).isEqualTo(-40);
    }

    @Test
    @DisplayName("-(8 + 2) = -10")
    void t30(){
        assertThat(Calc.run("-(8+2) = -10")).isEqualTo(-10);
    }

    @Test
    @DisplayName("-(8) = -8")
    void t31(){
        assertThat(Calc.run("-(8) = -8")).isEqualTo(-8);
    }

    @Test
    @DisplayName("3 + 5 * 7 = 38")
    void t32(){
        assertThat(Calc.run("3 + 5 * 7 = 38")).isEqualTo(38);
    }
}
