...
public class CalTest {
    ...
    void t18() {
        int num=Calc.run("(10 + 20)");
        assertThat(num).isEqualTo(30);
    }
    ...
    @DisplayName("-(10 + 5) == -15")
    void t25() {
        int num=Calc.run("-(10 + 5)");
        assertThat(num).isEqualTo(-15);
    }

    @Test
    @DisplayName("-(8 + 2) * -(7 + 3) + 5 == 105")
    void t26() {
        int num=Calc.run("-(8 + 2) * -(7 + 3) + 5");
        assertThat(num).isEqualTo(105);
    }
